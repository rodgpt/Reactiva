...
numeric_dates <- as.numeric(sub("\\.0$", "", datos_zarpe$FECHA))
datos_zarpe$FECHA <- as.Date(numeric_dates, origin = "1899-12-30")

# Identificar y filtrar por la última fecha en zarpes
ultima_fecha_zarpe <- max(datos_zarpe$FECHA, na.rm = TRUE)
...
summary_table <- read.csv("https://drive.google.com/uc?export=download&id=1CpqcOfoJvL9blgtCc04NKxO9ZiJnSWDF")
summary_table %>%
